...
public class Run{
	public static void main(String[] args)
		...
		if(args[0].equals("insertHeFits")){
		...
		else if(args[0].equals("HeFitsFormat")){
			HeFitsFormat.formatDir("/sbdvol/fitsfile/0301/Max", "/fits/HE/0301");
		}else if(args[0].equals("HeFitsInsert")){
			...
			if(job1.waitForCompletion(true)){
				...
				HFileOutputFormat2.configureIncrementalLoad(job2, hTable, connection.getRegionLocator(TableName.valueOf(tableName)));
